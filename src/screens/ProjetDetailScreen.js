    ...
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View
          ...
          {projet.matricule ? (
            <Row label="Matricule" value={projet.matricule} C={C} />
          ) : null}
        ...
        {projet.equipe?.length > 0 && (
          <View
            ...
            {projet.equipe.map((m, i) => (
              <View
                key={m.matricule || i}
                style={[styles.membreRow, { borderTopColor: C.border }]}>
                <View
                  style={[
                    styles.membreAvatar,
          ...
          <View style={[styles.modalBox, { backgroundColor: C.modalBox }]}>
            ...
            <TextInput
              ...
              onChangeText={(val) => {
                ...
                let f = digits;
                if (digits.length > 2)
                  f = digits.slice(0, 2) + "/" + digits.slice(2);
                if (digits.length > 4)
                  f =
                    digits.slice(0, 2) +
                    "/" +
